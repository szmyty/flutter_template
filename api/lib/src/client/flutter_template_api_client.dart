...
/// {@template flutter_template_api_malformed_response}
/// An exception thrown when there is a problem decoded the response body.
/// {@endtemplate}
class FlutterTemplateApiMalformedResponse implements Exception {
  /// {@macro flutter_template_api_malformed_response}
  const FlutterTemplateApiMalformedResponse({required this.error});

  /// The associated error.
  final Object error;
}

/// {@template flutter_template_api_request_failure}
/// An exception thrown when an http request failure occurs.
/// {@endtemplate}
class FlutterTemplateApiRequestFailure implements Exception {
  /// {@macro flutter_template_api_request_failure}
  const FlutterTemplateApiRequestFailure({
...
/// {@template flutter_template_api_client}
/// A Dart API client for the Flutter Template API.
/// {@endtemplate}
class FlutterTemplateApiClient {
  /// Create an instance of [FlutterTemplateApiClient] that integrates
  /// with the remote API.
  ///
  /// {@macro flutter_template_api_client}
  FlutterTemplateApiClient({
  ...
  ///
  /// {@macro flutter_template_api_client}
  FlutterTemplateApiClient.localhost({
    required TokenProvider tokenProvider,
    http.Client? httpClient,
  }) : this._(
  ...
  Future<ArticleResponse> getArticle({
    ...
    if (response.statusCode != HttpStatus.ok) {
      throw FlutterTemplateApiRequestFailure(
        body: body,
  ...
  Map<String, dynamic> json() {
    try {
      ...
      Error.throwWithStackTrace(
        FlutterTemplateApiMalformedResponse(error: error),
        stackTrace,
      );
    }
  }
