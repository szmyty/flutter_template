...
void main() {
  ...
  group('FlutterTemplateApiClient', () {
    late http.Client httpClient;
    late FlutterTemplateApiClient apiClient;
    ...
    setUp(() {
      ...
      apiClient = FlutterTemplateApiClient(
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => FlutterTemplateApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = FlutterTemplateApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test('makes correct http request (with authorization token).', () async {
        ...
        await FlutterTemplateApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
      ...
      test(
          'throws FlutterTemplateApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<FlutterTemplateApiMalformedResponse>()),
        );
      });

      test(
          'throws FlutterTemplateApiRequestFailure '
        ...
        expect(
          () => apiClient.getArticle(id: articleId),
          throwsA(
            isA<FlutterTemplateApiRequestFailure>()
