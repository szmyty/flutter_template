...
import 'package:flutter_template_api/client.dart' as api;
...
class MockFlutterTemplateApiClient extends Mock
    implements api.FlutterTemplateApiClient {}
...
void main() {
  group('UserRepository', () {
    ...
    late MockFlutterTemplateApiClient apiClient;
    ...
    setUp(() {
      ...
      apiClient = MockFlutterTemplateApiClient();
